...
from common.string_normalization import remove_snake_case, replace_x_and_y, apply_label_casing, \
    apply_property_snakecase, apply_single_quotes, contains
from common.vectorization import vector_top_k_old
...
def create_axiomatic_property_definition(elem_label: str, phrase_diffs_dict, target_info: dict[str, Any]) -> str:
