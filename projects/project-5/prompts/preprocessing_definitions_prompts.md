...
In the rest of the explanation the label of the genus is referred to as Y and the description of the differentia is
referred to as Z.
...
'X' is the label of the class to be improved, 'Y' is the label of parent class or genus of the target CLASS, and 'Z' is
a description of the differentia.
...
If you find a property label that helps to clarify the definition of the differentia, focus on the domain and range of
that property..
...
THe word "iff" appears just after the words "individual i is a 'XYZ' individual j", where 'XYZ' is the label of the
target ClASS.
...
- The improved definition must start with: `'individual i ...`.
...
Here is the reference context with class and property labels that can help to clarify the differentia.

Property labels that can help to clarify the definition of the differentia:
{property_reference_context}

Class labels that can help to clarify the definition of the differentia:
...
The differentia are described in terms of the domain and range of the property, and the difference with respect to the
domain and range of its parent property.
A property is recognizable because the label of the property is a verb or a verb phrase, like: has, is about, is part
of, is carrier of.
...
- For describing 'Y', 'C' and 'D', the provided parent 'Y', domain 'C' and range 'D' in the axiomatic definition are to
  be
...
- Expressions in single quotes are used to refer to the labels of other ontology elements.These expressions MUST NOT be
  rewritten and should always be part of the improved definition, with the quotes.
- Make sure to refer to explicitly refer to 'individual i' and 'individual j' in the definition where appropriate,
  instead of just 'x' or another letter.
